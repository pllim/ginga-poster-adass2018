...
%[width=0.7\textwidth]
\articlefigure{P11-3_f2.eps}{fig2}{BackgroundSub plugin for background subtraction.}
...
%[width=0.7\textwidth]
\articlefigure{P11-3_f4.eps}{fig4}{DQInspect plugin for data quality inspection.}
...
%[width=0.7\textwidth]
%\articlefigure{P11-3_f5.eps}{fig5}{SNRCalc plugin for SNR calculation.}
