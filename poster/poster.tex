...
to all images across all channels; thus, only one instance can be opened
...
{\tt https://ginga.readthedocs.io/en/latest/manual/}\\
{\tt developers.html\#writing-plugins-for-the-reference-viewer}.
Existing plugins in Ginga and {\tt stginga} code repositories can be used as
templates. It is recommended that you choose one that is the closest to your
desired functionality as a starting point.
